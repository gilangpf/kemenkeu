...
<!--                     <div id="chartContainer" style="height: 400px; width: 50%;"></div> 
        ...
        <table>
            <tr><td rowspan="12">
                <img style="height: 200px; width: 200px;" src="<?php echo "images/barang/".$data['img1'] ?>">
                <img style="height: 200px; width: 200px;" src="<?php echo "images/barang/".$data['img2'] ?>"> 
            </td></tr>
            <tr><td>Nama</td><td>&nbsp;:&nbsp;</td>
            ...
            <td><?php echo $data['link_web2']; ?></td>
                ...
                <img style="height: 200px; width: 200px;" src="<?php echo "images/barang/".$data['img3'] ?>">
                <img style="height: 200px; width: 200px;" src="<?php echo "images/barang/".$data['img4'] ?>"> 
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="print_aset.php?id=<?php echo $data['id'] ?>" class="btn btn-primary">Print</a>
            <!-- <tr><td>
            </td></tr>
                <img style="height: 200px; width: 200px;" src="<?php echo "images/barang/".$data['img3'] ?>"> 
                <img style="height: 200px; width: 200px;" src="<?php echo "images/barang/".$data['img4'] ?>">
