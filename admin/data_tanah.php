...
<!--                     <div id="chartContainer" style="height: 400px; width: 50%;"></div> 
        ...
        <table>
            <tr><td rowspan="16">
                <img style="height: 200px; width: 200px;" src="<?php echo "images/tanah/".$data['img1'] ?>">
                <img style="height: 200px; width: 200px;" src="<?php echo "images/tanah/".$data['img2'] ?>"> 
            </td></tr>
            <tr><td>Nama</td><td>&nbsp;:&nbsp;</td>
            ...
            <td><?php echo $data['link_web2']; ?></td>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="print_tanah.php?id=<?php echo $data['id'] ?>" class="btn btn-primary">Print</a>
