        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-file-text"></i>Aset</a>
                        <ul class="sub-menu children dropdown-menu">
...
<!--                <div id="chartContainer" style="height: 400px; width: 50%;"></div>
                    ...
                    <form method="post" action="upload_aset.php" enctype="multipart/form-data">
                    
                    <table>
                    <tr><td>Judul</td>
                            <td>
                                <input type="text" name="judul_a">
                            </td><tr>
                    <tr>
                        <td>
                    ...
                    <table>
                        <tr>
                            <tr><td>Data 1</td></tr>
                            <td>
                                <input type="file" name="img1_a" onchange="preview_image(event)">
                                <br><img id="output_image"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="file" name="img2_a" onchange="preview_image1(event)">
                        ...
                        <tr>
                            <tr><td>Data 2</td></tr>
                            <td>
                                <input type="file" name="img3_a" onchange="preview_image2(event)">
                                <br><img id="output_image2"/>
                            </td>
                            </tr>
                        <tr>
                            <td>
                                <input type="file" name="img4_a" onchange="preview_image3(event)">
                    ...
                    <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="judul1_a">
                            </td>
                        </tr>
                        <tr>
                            <td>Tanggal Iklan</td>
                            <td><input type="date" name="tgl1_a"></td>
                        </tr>
                        <tr>
                            <td>Keterangan</td>
                            <td><input type="text" name="keterangan1_a" style="width: 150%"></td>
                        </tr>
                        <tr>
                            <td>Link Web</td>
                            <td><input type="text" name="link1_a"></td>
                        </tr>
                        <tr>
                            <td>Data 2</td></tr><tr>
                            <td>Judul</td>
                            <td>
                                <!-- <input type="hidden" name="id" value=""> -->
                                <input type="text" name="judul2_a">
                            </td>
                        </tr>
                        <tr>
                            <td>Tanggal Iklan</td>
                            <td><input type="date" name="tgl2_a"></td>
                        </tr>
                        <tr>
                            <td>Keterangan</td>
                            <td><input type="text" name="keterangan2_a" style="width: 150%"></td>
                        </tr>
                        <tr>
                            <td>Link Web</td>
                            <td><input type="text" name="link2_a"></td>
                        </tr>
                    </table></td></tr></table>
                    <br><input type="submit" value="Submit" name="upload_a"> 
                    </form>
                </div>
