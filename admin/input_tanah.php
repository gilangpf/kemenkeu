...
<!--                <div id="chartContainer" style="height: 400px; width: 50%;"></div>
                    ...
                    <form method="post" action="upload_tanah.php" enctype="multipart/form-data">
                    <table>
                    <tr><td>Judul</td>
                            <td>
                    ...
                    <table>
                        <tr>
                            <tr><td>Data 1</td></tr>
                            <td>
                                <input type="file" name="img1" onchange="preview_image(event)">
                                <br><img id="output_image"/>
                            </td>
                             </tr>
                        <tr>
                            <td>
                                <input type="file" name="img2" onchange="preview_image1(event)">
                        ...
                        <tr>
                            <tr><td>Data 2</td></tr>
                            <td>
                                <input type="file" name="img3" onchange="preview_image2(event)">
                                <br><img id="output_image2"/>
                            </td>
                             </tr>
                        <tr>
                            <td>
                                <input type="file" name="img4" onchange="preview_image3(event)">
                    ...
                    <td>
                        ...
                        <tr>
                            <td>Keterangan</td>
                            <td><input type="text" name="keterangan1" style="width: 150%"></td>
                        </tr>
                        <tr>
                            <td>Tanggal Iklan</td>
                        ...
                        <tr>
                            <td>Keterangan</td>
                            <td><input type="text" name="keterangan2" style="width: 150%"></td>
                        </tr>
                        <tr>
                            <td>Tanggal Iklan</td>
